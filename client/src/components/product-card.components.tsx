...
const Card: React.FC<Props> = ({ product, onClick }) => {
	...
	return (
		<div className='card border m-4 mx-auto w-4/5 md:w-80 bg-base-100 shadow-lg hover:cursor-pointer hover:shadow-2xl hover:scale-105 transition-all h-60' onClick={onClick}>
