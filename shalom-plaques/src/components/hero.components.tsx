...
const Hero = () => {
	return (
		<div className="lg:absolute z-10 h-fit  lg:h-full lg:w-full bg-amber-400 lg:bg-transparent lg:bg-gradient-to-b lg:from-toph lg:to-topb">
			<div className="w-full h-full text-center text-white p-1/10 font-serif">
				...
				<button className="p-4 bg-secondary rounded-lg text-primary font-bold font-sans">View Products</button>
			</div>
		</div>
	);
};
